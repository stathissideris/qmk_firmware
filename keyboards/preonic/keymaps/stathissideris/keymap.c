...
[_ASCEND] = LAYOUT_preonic_grid(
  ...
  _______, _______, LGUI(KC_W), LGUI(LSFT(LALT(LCTL(KC_9)))), KC_MS_WH_UP,   KC_MS_BTN1, KC_MS_UP,   KC_MS_BTN2,  CLOCK_IN,      CLOCK_OUT,     WBAL,       _______,
  _______, _______, _______,    _______,                      KC_MS_WH_DOWN, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_MS_WH_UP,   KC_MS_BTN1,    KC_MS_UP,   KC_MS_BTN2,
  _______, _______, _______,    LGUI(KC_EQL),                 _______,       _______,    _______,    _______,     KC_MS_WH_DOWN, KC_MS_LEFT,    KC_MS_DOWN, KC_MS_RIGHT,
